...
# MAGIC
# MAGIC Para isso, apresentaremos os resultados para as duas perguntas por diversas formas de consulta. Neste caso, consideraremos o mês de referência como **dropoff_time_year_month** e consideraremos somente viagens de **janeiro** a **maio**
...
# MAGIC     GROUP BY 1
# MAGIC     ORDER BY dropoff_time_year_month
# MAGIC )
# MAGIC
...
# MAGIC
# MAGIC Para isso, apresentaremos os resultados para as duas perguntas por diversas formas de consulta. Neste caso, consideraremos o mês de referência como **dropoff_time_year_month**.
...
# MAGIC WHERE
# MAGIC     dropoff_time_year_month = '2023-05'
# MAGIC ORDER BY 1 ASC, 2 ASC
