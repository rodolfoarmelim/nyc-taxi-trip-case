...
\n 6 = Myle Technologies Inc',
    ...
    dropoff_datetime TIMESTAMP COMMENT 'The date and time when the meter was disengaged.',
    taxi_color STRING COMMENT 'Identifier for the taxi color: yellow or green.',
    dropoff_time_hour INT COMMENT 'The hour component extracted from the dropoff datetime.',
    is_passenger_count_recorded BOOLEAN COMMENT 'Flag indicating if the passenger_count is greater than zero and not null.',
...
PARTITIONED BY (dropoff_time_year_month);
"""
...
CREATE TABLE IF NOT EXISTS nyc_taxi.gold.tb_gold_taxi_trips_analysis_per_hour_per_month_full (
    dropoff_time_hour INT COMMENT 'The hour component extracted from the dropfoo datetime.',
